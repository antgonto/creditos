...
namespace BLL
{
    public class Procesador_pago
    {
        ...
        #region metodos
        public string carga_lista_procesadores()
        {
        ...
        public bool agregar_procesador_pago(string accion)
        {
            conexion = cls_DAL.trae_conexion("Progra5", ref mensaje_error, ref numero_error);
            if (conexion == null)
            {
            ...
            else
            {
                ...
                cls_DAL.agregar_datos_estructura_parametros(ref parametros, 6, "@usuario_nom_usu", SqlDbType.VarChar, _usuario_nom_usu );
        ...
        public bool eliminar_procesador_pago(string cod_planta)
        {
            conexion = cls_DAL.trae_conexion("Progra5", ref mensaje_error, ref numero_error);
            if (conexion == null)
            {
            ...
            {
                sql = "stp_procesa_pago_eliminar";
                ParamStruct[] parametros = new ParamStruct[2];
                cls_DAL.agregar_datos_estructura_parametros(ref parametros, 0, "@cod_proc", SqlDbType.VarChar, _cod_proc);
        ...
        public bool modificar_procesador_pago(string accion)
        {
            {
                conexion = cls_DAL.trae_conexion("Progra5", ref mensaje_error, ref numero_error);
                if (conexion == null)
                ...
                else
                {
                    ...
                    {
                        sql = "stp_procesa_pago_modificar";
                    }
                    ...
                    cls_DAL.agregar_datos_estructura_parametros(ref parametros, 7, "@usuario_nom_usu", SqlDbType.VarChar, _usuario_nom_usu);
                    cls_DAL.conectar(conexion, ref mensaje_error, ref numero_error);
                    cls_DAL.ejecuta_sqlcommand(conexion, sql, true, parametros, ref mensaje_error, ref numero_error);
                    if (numero_error != 0)
                    {
